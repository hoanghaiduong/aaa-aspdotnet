...
namespace DAL.Migrations
{
    ...
    [Migration("20231109163946_allowNullRefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aaa_aspdotnet.src.DAL.Entities.Plan", b =>
                {
                    b.Property<int>("PlanId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("aaa_aspdotnet.src.DAL.Entities.Role", b =>
                {
            ...
            modelBuilder.Entity("aaa_aspdotnet.src.DAL.Entities.DailyDivision", b =>
                {
                    b.HasOne("aaa_aspdotnet.src.DAL.Entities.Device", "Device")
                        .WithMany("DailyDivisions")
                        .HasForeignKey("DeviceId")
                        .IsRequired()
                        .HasConstraintName("fk_DailyDivision_Device");

                    b.HasOne("aaa_aspdotnet.src.DAL.Entities.Plan", "Plan")
                        .WithMany("DailyDivisions")
                        .HasForeignKey("PlanId")
                        .IsRequired()
                        .HasConstraintName("fk_DailyDivision_Plan");

                    b.HasOne("aaa_aspdotnet.src.DAL.Entities.WorkStatus", "Status")
                        .WithMany("DailyDivisions")
            ...
            modelBuilder.Entity("aaa_aspdotnet.src.DAL.Entities.Device", b =>
                {
                    b.HasOne("aaa_aspdotnet.src.DAL.Entities.Factory", "Fac")
                        .WithMany("Devices")
                        .HasForeignKey("FacId")
                        .IsRequired()
                        .HasConstraintName("fk_Device_Factory");

                    b.HasOne("aaa_aspdotnet.src.DAL.Entities.DeviceType", "Type")
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("aaa_aspdotnet.src.DAL.Entities.User", b =>
                {
                    b.HasOne("aaa_aspdotnet.src.DAL.Entities.Role", "Role")
                        .WithMany("Users")
